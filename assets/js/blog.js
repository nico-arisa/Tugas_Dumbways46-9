...
function getProject(event) {
    ...
    let upimg = document.getElementById('upimg').files[0]

    upimg = URL.createObjectURL(upimg);
    ...
    let data = { projectName, startdate, enddate, description, nodeJs, nextJs, reactJs, typeScript, upimg }
